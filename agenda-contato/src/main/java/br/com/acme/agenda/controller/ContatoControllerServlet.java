...
public class ContatoControllerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//adicionar switch para direcionar para a função correspondente a action
		//adicionar action para editar
		//adicionar try catch 
		//adicionar action para remover
				...
				switch (action) {
					case "delete":
						try {
							...
							//atributo apenas para exibir a mensagem que foi deletado na tela
							request.setAttribute("response", "Contato deletado");
						} catch (Exception e) {
							System.out.println(e.getMessage());
							request.setAttribute("response", "Não consegui deletar");
						}
					...
					case "editar":
						...
						try {
							...
							System.out.println(e.getMessage());
							request.setAttribute("response", "Não consegui editar");
						}
						
						break;
					case "ativar": 
						this.service.ativarDesativarContato(Long.parseLong(id)); 
						request.setAttribute("response", "Status alterado");
						break;
					default:
						break;
				}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//setar os atributos na instância de contato
		...
		if (id != null && id != "") {
			...
			request.setAttribute("response", "Contato editado");
		} else {
			this.service.salvar(this.contato);
			request.setAttribute("response", "Contato cadastrado");
		}
